...
/*
Plugin Name: WooSync
Description: Enterprise-grade sync for supplier products, stock, categories, and colours into WooCommerce with field mapping, progress tracking, and automated cron scheduling.
Version: 3.4.1
...
function amrod_get_vendor_credential_schemas() {
    return [
        'amrod' => [
            ...
            'description' => 'Uses Amrod VendorLogin endpoint with username, password, and customer code.',
            'fields' => [
                [
                    'key' => 'auth_url',
                    'label' => 'Auth URL',
        ...
        'custom' => [
            ...
            'fields' => [
                [
                    ...
                    'required' => true,
                    'type' => 'url',
                    'help' => 'Base URL for your vendor API',
                ],
                [
                    'key' => 'auth_url',
...
function amrod_render_main_page() {
    ...
    <div class="container-fluid mt-4 amrod-container">
            ...
            <div class="col-md-3">
                <div class="card h-100">
                    <div class="card-body text-center">
                        <div class="status-dot <?php echo esc_attr($status['connection_status']); ?> mb-2"></div>
                        <h5 class="card-title">API Connection</h5>
                        <p class="card-text text-muted small"><?php echo esc_html($status['connected']) ? 'Connected to Supplier' : 'Not configured'; ?></p>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="quickSyncForm">
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="batch_size" value="<?php echo esc_attr($batch_size); ?>" min="50" max="500" class="form-control">
                                </div>
                                <div class="col-md-4">
                        ...
                        <!-- Progress Bar -->
                        <div id="syncProgress" class="woosync-hidden" class="mt-3">
                            <div class="progress" class="progress woosync-progress-height">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="badge bg-<?php echo esc_attr($last_token_time ? 'success' : 'warning'); ?>">
                                <?php echo esc_html($last_token_time ? date('H:i', strtotime($last_token_time) + 55*60) : 'Not fetched'); ?>
                            </span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span>Auto-Update:</span>
                            <span class="badge bg-<?php echo esc_attr($auto_update ? 'success' : 'secondary'); ?>">
                                <?php echo esc_html($auto_update ? 'Enabled' : 'Disabled'); ?>
                            </span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span>API Endpoints:</span>
                            <span class="badge bg-info">
                                <?php echo esc_html(count(array_filter(amrod_get_endpoints(), fn($e) => $e['enabled']))); ?> enabled
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body" class="woosync-scroll-300">
                <div id="syncLog">
                    <?php
    ...
    <div class="container-fluid mt-4 amrod-container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                ?>
                <div class="card mb-3 tier-card tier-card-<?php echo esc_attr(strtolower($tier)); ?>">
                    <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><?php echo amrod_get_tier_icon($tier); ?> Supplier — <?php echo esc_html($tier); ?> Tier</h5>
                        <span class="tier-badge <?php echo amrod_get_tier_color_class($tier); ?>"><?php echo esc_html($tier); ?></span>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <small class="text-muted d-block">Your pricing level</small>
                                <strong><?php echo esc_html($tier); ?></strong>
                            </div>
                            <div class="col-6">
                ...
                <div class="card mb-3">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <div class="status-dot <?php echo esc_attr($status['connection_status']); ?>"></div>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div id="connectionStatus" class="mt-3" class="woosync-hidden"></div>
                    </div>
                </div>
            ...
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="searchResults" class="list-group mb-3" class="woosync-scroll-hidden-200"></div>

                        <!-- Product Preview Card -->
                        <div id="productPreview" class="border rounded p-3" class="woosync-bg-surface">
                            <div class="text-center text-muted py-5">
                                <div class="mb-3" class="woosync-icon-xl">📦</div>
                        ...
                        <div id="tierPricingBreakdown" class="mt-3 woosync-hidden">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input endpoint-toggle" type="checkbox" 
                                           id="ep_<?php echo esc_attr($key); ?>" 
                                           data-endpoint="<?php echo esc_attr($key); ?>"
                                           <?php checked($ep['enabled']); ?>>
                                    <label class="form-check-label" for="ep_<?php echo esc_attr($key); ?>">
                                        <strong><?php echo esc_html($ep['label']); ?></strong>
                                        <small class="text-muted d-block"><?php echo esc_html($ep['path']); ?></small>
                                    </label>
                                </div>
                            </div>
...
function amrod_render_mapping_tab($category, $fields) {
    ...
    <table class="table table-sm table-bordered mb-0">
        <thead class="table-light">
            <tr>
                <th class="woosync-w-40">Amrod Field</th>
                <th class="woosync-w-10"></th>
                <th class="woosync-w-50">WooCommerce</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <td>
                    <input type="text" name="mapping[<?php echo esc_attr($wc_key); ?>]" 
                           value="<?php echo esc_attr($mapping[$wc_key] ?? ''); ?>" 
                           class="form-control form-control-sm" 
                           placeholder="e.g., <?php echo esc_attr($wc_key === 'sku' ? 'ProductCode' : ucfirst($wc_key)); ?>">
                </td>
                <td class="text-center align-middle">→</td>
                <td class="align-middle">
                    <small><?php echo esc_html($wc_fields[$wc_key] ?? $wc_key); ?></small>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <div class="container-fluid mt-4 amrod-container">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <span class="tier-badge <?php echo amrod_get_tier_color_class($tier); ?> fs-5 px-3 py-2">
                            <?php echo amrod_get_tier_icon($tier); ?> <?php echo esc_html($tier); ?> Tier
                        </span>
        ...
        <div class="card mb-4 border-warning">
            ...
            <div class="card-body">
                ...
                <div id="tierSavingsTable" class="woosync-scroll-400">
        ...
        <!-- Log Entries -->
        <div class="card">
            <div class="card-body" class="woosync-scroll-500">
                <div id="logEntries">
                    <?php
                    if (empty($log)) {
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" name="amrod_batch_size" value="<?php echo esc_attr($batch_size); ?>" min="50" max="500" class="form-control">
    ...
    <div class="container-fluid mt-4 amrod-container" id="promoShareTab">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2 align-items-center">
                <small class="text-muted">Last updated: <?php echo esc_html($last_fetch); ?></small>
        ...
        <!-- Error Container -->
        <div id="promoError" class="woosync-hidden"></div>
                ...
                <form id="promoEmailForm">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="emailUserList" class="woosync-hidden">
...
function amrod_render_pricing_page() {
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="form-check form-switch pricing-toggle">
                <input class="form-check-input" type="checkbox" id="tieredPricingEnabled" <?php checked($tiered_enabled); ?>>
                                <div id="pricingSuccessMsg" class="alert alert-success mt-2 d-none">Default markup saved!</div>
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="pricing-stat-card">
                    <div class="stat-value"><?php echo esc_html(count($role_markups)); ?></div>
                    <div class="stat-label">User Roles</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="pricing-stat-card">
                    <div class="stat-value"><?php echo esc_html(count($user_markups)); ?></div>
                    <div class="stat-label">Custom Customers</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="pricing-stat-card">
                    <div class="stat-value"><?php echo esc_html($default_markup); ?>%</div>
                    <div class="stat-label">Default Markup</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="pricing-stat-card">
                    <div class="stat-value"><?php echo esc_html($min_margin); ?>%</div>
                ...
                <div class="card pricing-card">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover role-tiers-table mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th class="woosync-w-30">Role Name</th>
                                    <th class="woosync-w-20">Markup %</th>
                                    <th class="woosync-w-15">Status</th>
                                    <th class="woosync-w-35">Notes</th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <div class="card pricing-card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div id="customerSearchResults" class="list-group" class="woosync-scroll-hidden-200"></div>
                                </div>
                                
                                <div id="selectedCustomer" class="border rounded p-3 woosync-hidden">
                                ...
                                <div id="customerEditForm" class="mt-3 woosync-hidden">
                                    <div class="mb-2">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="woosync-scroll-400">
                                    ...
                                    <table class="table table-hover mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                <th class="woosync-w-5"><input type="checkbox" id="selectAllCustomers"></th>
                                                <th class="woosync-w-30">Customer</th>
                                                <th class="woosync-w-20">Markup</th>
                                                <th class="woosync-w-25">Tier</th>
                                                <th class="woosync-w-20">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div id="productSearchResults" class="list-group" class="list-group woosync-dropdown-search"></div>
                                    </div>
                        ...
                        <div class="card pricing-card">
                            ...
                            <div class="card-body">
                                <div id="pricePreviewResult" class="price-preview-box">
                                    <div class="text-center text-muted py-5">
                                        <div class="woosync-icon-xl-sm">📊</div>
    ...
    jQuery('#saveDefaultMarkup').on('click', function() {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    jQuery('#pricingSuccessMsg').removeClass('d-none');
                }
            }
        });
    });
